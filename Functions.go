...
func Vouchers(feilds string, sort string, limit string, offset string) ArrayOfVouchers {
	...
	url := fmt.Sprintf("https://api.hotspotsystem.com/v2.0/vouchers?fields=%s&sort=%s&limit=%s&offset=%s", safeFeilds, safeSort, safeLimit, safeOffset)
